...
function addClientRow(botid) {
    ...
    row.append($('<td></td>').attr('class', 'client-uptime-total active').text('None'));
...
},{"browser-request":3,"format-duration":4,"jquery":5}],2:[function(require,module,exports){
(function(exports) {
...
},{"add-zero":2,"parse-ms":6}],5:[function(require,module,exports){
/*!
